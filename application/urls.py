...
from profiles.views import ContactUser,CurrentUser,LoginView,LogoutView,LogoutAllView
...
urlpatterns = [
    ...
    path(f"{URL_HEADER}/contact-user/",ContactUser.as_view(),name="contact-user"),
